                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form method="post">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="control-label" type="phone" for="phone">phone</label>
                                        <!-- <input type="text" name="country_code" title="Error Message" pattern="[1-9]{1}[0-9]{9}"> -->
                                        <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone" required="true" minlength="10" maxlength="10" pattern="[0-9]+">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="control-label" type="email" for="email">email</label>
